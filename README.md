...
Otherwise if you want to know how to use "virtual resources" you should take a look at **Orders** resource. To add new order: POST request (no changes on the system state but a [new order id will be generated](https://github.com/marlandy/rest-idempotency/blob/master/src/main/java/com/autentia/tutorial/idempotency/order/service/impl/OrderKeyGeneratorImpl.java)) and then PUT into virtual resource URL.
